...
`ifdef MAX_MEM
 ...
 initial
       ...
       reg [BA_BITS + ROW_BITS + COL_BITS - 1 : 0] addr29;
       reg [511 : 0] data;
       reg [63 : 0] data64;
       reg [31:0] addr;
       string _char;
           ...
           in = $fopen("..//mem_init.txt","r");
               while (! $feof(in)) begin
                   ...
                   if (fio_status != -1) begin // Check for blank line or EOF
                       bank = addr29 [BA_BITS + ROW_BITS + COL_BITS - 1 : ROW_BITS + COL_BITS];
                       row = addr29 [ROW_BITS + COL_BITS - 1 : COL_BITS];
                       col = addr29 [COL_BITS - 1 : 0];
                       case(id)
                           0: data64 = data[63  : 0  ];
                           1: data64 = data[127 : 64 ];
                           2: data64 = data[191 : 128];
                           3: data64 = data[255 : 192];
                           4: data64 = data[319 : 256];
                           5: data64 = data[383 : 320];
                           6: data64 = data[447 : 384];
                           7: data64 = data[511 : 448];
                           default: data64 = 0;
                       endcase
