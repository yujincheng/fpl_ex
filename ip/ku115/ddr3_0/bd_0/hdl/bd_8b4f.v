...
//Date        : Tue May 23 18:21:54 2017
//Host        : yujc-Z97-HD3 running 64-bit Ubuntu 16.04.2 LTS
//Command     : generate_target bd_8b4f.bd
//Design      : bd_8b4f
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_8b4f,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_8b4f,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "ddr3_0_microblaze_mcs.hwdef" *) 
module bd_8b4f
   (Clk,
    IO_addr_strobe,
    IO_address,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_8b4f lmb_bram_I bd_8b4f second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_8b4f_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_8b4f_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_8b4f_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_8b4f_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_8b4f dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_8b4f_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_8b4f_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_8b4f_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_8b4f_second_lmb_bram_I_0 second_lmb_bram_I
