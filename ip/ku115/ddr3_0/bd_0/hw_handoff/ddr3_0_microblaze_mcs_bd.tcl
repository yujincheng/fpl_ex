...
################################################################
# This is a generated script based on design: bd_8b4f
#
...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xcku060-ffva1517-1-c
}


# CHANGE DESIGN NAME HERE
set design_name bd_8b4f
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./ddr3_0_ex.srcs/sources_1/ip/ddr3_0/bd_0
